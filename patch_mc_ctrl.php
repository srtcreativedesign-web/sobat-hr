<?php
$file = '/Applications/XAMPP/xamppfiles/htdocs/sobat-hr/sobat-api/app/Http/Controllers/Api/PayrollMoneyChangerController.php';
...
echo "PayrollMoneyChangerController patched.\n";
