...
<body>
    <div class="header">
        <div class="company-name">TUNG TAU</div>
    ...
    <table class="info-table">
        <tr>
            ...
            <td style="width: 100px; text-align: right;">: SAL-TT-{{ $payroll->id }}</td>
        </tr>
        <tr>
            <td class="info-label">Divisi</td>
            <td>: FOOD & BEVERAGE - TUNGTAU</td>
    ...
    <table class="details-table">
        ...
        @if($payroll->deduction_shortage > 0)
        <tr>
            <td>Selisih SO / Barang Hilang</td>
            <td class="amount">Rp {{ number_format($payroll->deduction_shortage, 0, ',', '.') }}</td>
        </tr>
        @endif
