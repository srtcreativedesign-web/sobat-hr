    ...
    <div class="total-section">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="font-size: 14px; text-align: right;">Rp {{ number_format($payroll->net_salary, 0, ',', '.') }}</td>
            </tr>
            @if($payroll->ewa_amount > 0)
            <tr>
                <td style="font-size: 14px; padding-left: 20px;">- EWA (Early Wage Access)</td>
                <td style="font-size: 14px; text-align: right; color: #ffeb3b;">(Rp {{ number_format($payroll->ewa_amount, 0, ',', '.') }})</td>
            </tr>
            @endif
            <tr>
                <td style="border-top: 1px solid rgba(255,255,255,0.3); padding-top: 5px; font-size: 16px; font-weight: bold;">TOTAL DITRANSFER (PAYROLL)</td>
                <td style="border-top: 1px solid rgba(255,255,255,0.3); padding-top: 5px; font-size: 18px; font-weight: bold; text-align: right;">Rp {{ number_format($payroll->final_payment, 0, ',', '.') }}</td>
            </tr>
        </table>
    </div>
