...
<head>
    <meta charset="utf-8">
    <title>Slip Gaji Money Changer</title>
    <style>
        @page {
            margin: 10px 20px;
        }
...
<body>
    <div class="header">
        ...
        <div class="division-name">MONEY CHANGER</div>
    ...
    <table class="info-table">
        <tr>
            ...
            <td style="width: 120px; text-align: right;">: SAL-MC-{{ $payroll->id }}</td>
        </tr>
        <tr>
    ...
    <table class="details-table">
        ...
        <tr>
            <td>Lembur ({{ number_format($payroll->overtime_hours, 0) }} Jam)</td>
