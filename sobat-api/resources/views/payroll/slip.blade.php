        ...
        <table>
            ...
            <tbody>
                ...
                <tr style="background: #f9fafb; font-weight: bold;">
                    ...
                    @php
                        $gross_salary = $payroll->basic_salary + ($payroll->allowances ?? 0) + ($payroll->overtime_pay ?? 0);
                    @endphp
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount negative">{{ number_format($payroll->bpjs_ketenagakerjaan ?? 0, 0, ',', '.') }}
                    </td>
                </tr>
                <tr>
                    <td>PPh 21</td>
                ...
                <tr style="background: #fee2e2; font-weight: bold;">
                    ...
                    @php
                        $total_deductions = ($payroll->bpjs_kesehatan ?? 0) + ($payroll->bpjs_ketenagakerjaan ?? 0) + ($payroll->pph21 ?? 0) + ($payroll->other_deductions ?? 0);
                    @endphp
