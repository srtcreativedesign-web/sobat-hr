...
class PayrollMaximumController extends Controller
{
    ...
    {
        $user = auth()->user();
        $query = PayrollMaximum::with('employee');
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            $headerPatterns = [
                ...
                'payroll' => ['THP', 'Payroll'],
                'net_salary_am' => ['Total Gaji Ditransfer'],
    ...
    public function saveImport(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->rows as $index => $row) {
                ...
                $existing = PayrollMaximum::where('employee_id', $employee->id)
    ...
    {
        $payroll = PayrollMaximum::with('employee')->findOrFail($id);
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        $payroll = PayrollMaximum::findOrFail($id);
    ...
    public function generateSlip($id)
    {
        try {
            ...
            $pdf = PDF::loadView('payslips.maximum', [
                'payroll' => $payroll,
                'aiMessage' => $aiMessage
            ]);
