...
return new class extends Migration
{
    ...
    {
        Schema::create('payrolls_money_changer', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('attendance_allowance', 15, 2)->default(0); // Tunj. Kehadiran
            $table->decimal('health_allowance', 15, 2)->default(0);    // Tunj. Kesehatan
    ...
    {
        Schema::dropIfExists('payrolls_money_changer');
    }
};
