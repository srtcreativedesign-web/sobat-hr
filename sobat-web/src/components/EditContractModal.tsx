        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-fade-in-up">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h2 className="text-xl font-bold text-[#419cc3]">Edit Contract</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div>
                        ...
                        <div className="p-3 bg-gray-50 rounded-xl border border-gray-200">
                            <p className="font-bold text-[#419cc3]">{employee?.full_name}</p>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#419cc3]/20 focus:border-[#419cc3] outline-none transition-all"
                        />
                    </div>
                            ...
                            {['active', 'inactive'].map((s) => (
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-lg text-sm font-bold border transition-all ${formData.status === s
                                            ? 'bg-[#419cc3] text-white border-[#419cc3]'
                    ...
                    <div className="pt-4 flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 py-3 bg-[#419cc3] text-white rounded-xl font-bold hover:bg-[#2d1e24] transition-colors shadow-lg shadow-[#419cc3]/20"
                        >
