...
export interface LiquidEtherProps {
    ...
    color0?: string; // These seem unused in the provided code logic but were in the usage example
    color1?: string;
    color2?: string;
}
...
`;
        ...
        // This is checking if we already initialized to avoid double init in React Dev Mode
