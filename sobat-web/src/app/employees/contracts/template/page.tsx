                    ...
                    <div className="flex-1 p-8 flex flex-col gap-4 overflow-y-auto">
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 flex-1 flex flex-col overflow-hidden">
                            <ReactQuill
                                ...
                                onChange={setContent}
                                modules={modules}
                                className="h-full flex flex-col [&_.ql-container]:flex-1 [&_.ql-container]:overflow-y-auto [&_.ql-editor]:h-full [&_.ql-editor]:text-base [&_.ql-editor]:font-serif [&_.ql-editor]:text-[#419cc3]"
