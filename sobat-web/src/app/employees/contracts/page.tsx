        ...
        <DashboardLayout>
            <div className="p-8 space-y-8 min-h-screen bg-gray-50/50">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-[#419cc3]">Digital Contracts</h1>
                    ...
                    <div className="flex gap-3 flex-wrap items-center">
                        <button
                            ...
                            className="px-4 py-2 bg-white border border-[#419cc3] text-[#419cc3] rounded-xl text-sm font-medium hover:bg-[#419cc3] hover:text-white transition-all shadow-sm flex items-center gap-2"
                        >
                        ...
                        <select
                            ...
                            className="px-4 py-2 bg-white border border-gray-200 text-[#419cc3] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#419cc3]/20 text-sm"
                        >
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="pl-10 pr-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#419cc3]/20 w-64"
                            />
                ...
                <div className="flex gap-2 border-b border-gray-200 pb-1 overflow-x-auto">
                    {['all', 'active', 'expiring', 'expired'].map((f) => (
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium transition-colors relative ${filter === f ? 'text-[#419cc3]' : 'text-gray-400 hover:text-gray-600'
                                }`}
                        >
                            {f.charAt(0).toUpperCase() + f.slice(1)}
                            {filter === f && (
                                <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#419cc3] rounded-t-full"></div>
                            )}
                        </button>
                    ))}
                </div>
                ...
                <div className="glass-card bg-white overflow-hidden">
                    {loading ? (
                        <div className="py-20 flex flex-col items-center justify-center text-gray-400">
                            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#419cc3] mb-4"></div>
                            Loading contracts...
                        </div>
                            ...
                            <table className="w-full">
                                <thead className="bg-[#419cc3]/5 border-b border-[#419cc3]/10">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-[#419cc3] uppercase tracking-wider">Organization</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-[#419cc3] uppercase tracking-wider">Track</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-[#419cc3] uppercase tracking-wider">Contract End</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-[#419cc3] uppercase tracking-wider">Status</th>
                                        <th className="px-6 py-4 text-right text-xs font-semibold text-[#419cc3] uppercase tracking-wider">Action</th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr key={emp.id} className="hover:bg-gray-50/50 transition-colors group">
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#419cc3] to-[#93C5FD] text-white flex items-center justify-center font-bold text-sm shadow-sm">
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        <button
                                                            onClick={() => router.push(`/employees/contracts/generate/${emp.id}`)}
