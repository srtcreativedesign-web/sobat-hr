  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-8">
      ...
      <div className="absolute inset-0 z-0 bg-black">
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 z-20 bg-gradient-to-t from-[#419cc3]/40 via-transparent to-transparent"></div>
      </div>

      <main className="relative z-10 text-center max-w-4xl mx-auto space-y-8 animate-fade-in-up">
        {/* Logo / Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#89b4e1]/90 backdrop-blur-md border border-[#93C5FD]/20 shadow-lg">
          <span className="w-2 h-2 rounded-full bg-[#419cc3] animate-pulse"></span>
          <span className="text-[#419cc3] font-semibold tracking-wider text-sm uppercase">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-2 drop-shadow-lg">
          SOBAT <span className="text-[#89b4e1]">HR</span>
        </h1>
        ...
        <div className="flex justify-center items-center mb-6">
          ...
          <RotatingText
            ...
            mainClassName="px-3 sm:px-3 md:px-4 bg-[#89b4e1] text-[#419cc3] overflow-hidden py-1 sm:py-2 md:py-2 justify-center rounded-xl text-lg md:text-2xl font-bold"
            staggerFrom="last"
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
            exit={{ y: "-120%" }}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12">
          <Link
            href="/login"
            className="group relative px-8 py-4 bg-[#89b4e1] text-[#419cc3] font-bold text-lg rounded-xl shadow-[0_0_20px_rgba(169,234,226,0.3)] hover:shadow-[0_0_30px_rgba(169,234,226,0.5)] hover:scale-105 transition-all duration-300"
          >
            Get Started
