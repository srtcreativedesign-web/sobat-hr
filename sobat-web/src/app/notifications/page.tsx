                ...
                <div className="px-8 py-6 flex justify-between items-center">
                    ...
                    {unreadCount > 0 && (
                        <button
                            ...
                            className="px-4 py-2 bg-[#419cc3] text-white text-sm font-medium rounded-lg hover:bg-[#2d1e24] transition-colors"
                        >
                            Mark All as Read
                        </button>
                    )}
                    ...
                    {loading ? (
                        ...
                        <div className="divide-y divide-gray-100">
                            {notifications.map((notification) => (
                                ...
                                >
                                    {/* Icon */}
                                    <div className={`p-2 rounded-lg ${!notification.read_at ? 'bg-[#419cc3] text-white' : 'bg-gray-100 text-gray-500'}`}>
                                    ...
                                    {!notification.read_at && (
                                        <div className="w-2 h-2 bg-[#419cc3] rounded-full mt-2"></div>
                                    )}
                                </div>
                            ))}
                        </div>
