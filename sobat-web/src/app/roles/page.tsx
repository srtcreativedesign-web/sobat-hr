        ...
        <DashboardLayout>
            <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-2xl font-bold text-[#419cc3]">Roles Management</h1>
                        <p className="text-gray-500">Manage user roles and permissions.</p>
                    </div>
                    <button
                        onClick={() => handleOpenModal()}
                        className="px-4 py-2 bg-[#419cc3] text-white rounded-lg hover:bg-[#2d1e24] transition-colors flex items-center gap-2"
                    >
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    {loading ? (
                        <div className="p-12 text-center">
                            <div className="inline-block animate-spin rounded-full h-8 w-8 border-4 border-[#89b4e1] border-t-transparent"></div>
                        </div>
                    ) : (
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {roles.map((role) => (
                                        <tr key={role.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <code className="text-xs bg-gray-100 px-2 py-1 rounded text-[#419cc3] font-mono">{role.name}</code>
                                            </td>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    required
                                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#89b4e1] outline-none"
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    required
                                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#89b4e1] outline-none bg-gray-50 font-mono text-sm"
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 bg-[#419cc3] text-white rounded-lg hover:bg-[#2d1e24] transition-colors"
                                >
                                    Save
                                </button>
                            </div>
