    ...
    return (
        <DashboardLayout>
            <div className="flex justify-between items-center p-8 pb-0 animate-fade-in-up">
                <div>
                    <h1 className="text-2xl font-bold text-[#419cc3]">Organizations</h1>
                    <div className="flex gap-4 mt-2">
                        <div 
                            className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium transition-all border-b-2 border-[#419cc3] text-[#419cc3]"
                        >
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-[#419cc3] text-white font-semibold rounded-xl hover:bg-[#2d1e24] shadow-lg shadow-[#419cc3]/20 transition-all flex items-center gap-2"
                    >
