            ...
            <div className="p-8">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-[#1C3ECA] text-white rounded-xl hover:bg-[#2d1e24] transition-colors flex items-center gap-2"
                    >
                        ...
                        <div key={announcement.id} className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden group hover:shadow-md transition-all flex flex-col">
                            ...
                            <div className="relative h-48 w-full bg-gray-100">
                                ...
                                {announcement.is_banner && (
                                    <div className="absolute bottom-2 right-2 bg-[#1C3ECA] text-white p-1 rounded-full shadow-md" title="Popup Banner on Login">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        required
                                        className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1C3ECA]/20"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1C3ECA]/20 bg-white"
                                ...
                                <div className="space-y-3 pt-2">
                                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                        <input
                                            type="checkbox"
                                            id="is_active"
                                            className="w-5 h-5 rounded text-[#1C3ECA] focus:ring-[#1C3ECA]"
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-[#1C3ECA]/5 rounded-xl border border-[#1C3ECA]/10">
                                        <input
                                            type="checkbox"
                                            id="is_banner"
                                            className="w-5 h-5 rounded text-[#1C3ECA] focus:ring-[#1C3ECA]"
                                        ...
                                        />
                                        <div>
                                            <label htmlFor="is_banner" className="text-sm font-bold text-[#1C3ECA]">Popup Banner</label>
                                            <p className="text-xs text-[#1C3ECA]/70">Show full-screen popup on login</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end gap-3 mt-6">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[#1C3ECA] text-white rounded-xl hover:bg-[#2d1e24] transition-colors disabled:opacity-50"
                                    >
