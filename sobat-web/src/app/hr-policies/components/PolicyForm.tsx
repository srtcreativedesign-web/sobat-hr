            ...
            <div className="bg-white rounded-xl max-w-2xl w-full p-6 animate-fade-in-up">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            type="file"
                            className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#89b4e1]/20 file:text-[#419cc3] hover:file:bg-[#89b4e1]/30"
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            type="checkbox"
                            id="is_published"
                            className="w-4 h-4 text-[#419cc3] border-gray-300 rounded focus:ring-[#89b4e1]"
                            checked={isPublished}
