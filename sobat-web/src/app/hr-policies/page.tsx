        ...
        <DashboardLayout>
            <div className="p-6">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        <h1 className="text-3xl font-bold text-[#1C3ECA]">Informasi & Regulasi</h1>
                    ...
                    <button
                        ...
                        className="px-6 py-2.5 bg-[#1C3ECA] text-white rounded-xl hover:bg-[#2d1e24] transition-all shadow-lg shadow-[#1C3ECA]/20 flex items-center gap-2 font-medium"
                    >
