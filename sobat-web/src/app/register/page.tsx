...
function RegisterForm() {
    ...
    if (isSuccess) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1A4D2E]/5 to-[#49FFB8]/5 p-4">
                <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up border border-white/50 p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-8">
                        Akun Anda telah aktif. Silahkan login menggunakan aplikasi <span className="font-semibold text-[#1A4D2E]">Sobat Mobile</span>.
                    </p>
                </div>
            </div>
        );
            ...
            <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up border border-white/50">
                <div className="p-8">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold bg-gradient-to-r from-[#1A4D2E] to-[#49FFB8] bg-clip-text text-transparent">
                            Activate Account
                        </h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#1A4D2E] focus:ring-2 focus:ring-[#1A4D2E]/20 outline-none transition-all placeholder:text-gray-300"
                        ...
                        <button
                            ...
                            className="w-full py-3 px-4 bg-gradient-to-r from-[#1A4D2E] to-[#143d24] text-white rounded-lg font-semibold shadow-lg hover:shadow-[#1A4D2E]/30 transform hover:-translate-y-0.5 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                        >
