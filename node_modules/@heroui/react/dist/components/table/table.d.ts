...
interface TableSortableColumnHeaderProps extends Omit<React.ComponentPropsWithoutRef<"span">, "children"> {
...
declare const TableSortableColumnHeader: React.ForwardRefExoticComponent<TableSortableColumnHeaderProps & React.RefAttributes<HTMLSpanElement>>;
